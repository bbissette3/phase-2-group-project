      ...
      <div className="home">
        <div className="home-bio">
            ...
            <p>
              ...
              their own unique specialties and training styles, giving our
              clients a variety of different workouts to choose from. We take
              pride in our training and ability to work one-on-one with clients
              to give them the best diet and exercise routines that work with
              their individual lifestyles and body types. Sign up down below for
